...
import { deleteDocumentType } from "@/ApiRoutes/AdminApi";
...
export default function DocumentTypeTable({
  ...
  const columns = [
    { field: "name", headerName: "Document Type", width: 250 },
    {
      field: "edit",
      headerName: "Edit",
      width: 130,
  ...
  return (
    <>
      ...
      >
        <DataGrid
          rows={documentTypesData}
          rowHeight={100}
          columns={columns}
          getRowId={(row) => documentTypesData?.indexOf(row)}
          loading={loader}
          loadingIndicator={
            <Box
              display="flex"
