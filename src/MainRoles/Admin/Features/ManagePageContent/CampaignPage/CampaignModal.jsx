...
function CampaignModal({ open, onClose, onSave }) {
  ...
  const initialValues = {
    title: "",
    description: "",
    pdfButtonName: "Upload PDF Document",
  };
  ...
  const handleSave = async (formValues) => {
    try {
      ...
      toastMessage(200, "Campaign saved successfully");
      onSave();
      handleClose();
    } catch (error) {
      toastMessage(400, error.message || "Failed to save campaign");
    } finally {
      setLoading(false);
    }
  };
