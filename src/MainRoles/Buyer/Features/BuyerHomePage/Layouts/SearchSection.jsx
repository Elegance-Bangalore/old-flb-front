...
function SearchSection({ checked, filters, setFilters }) {
  ...
  function showCheckbox(min, max) {
    return Number(filters.priceMin) >= min && Number(filters.priceMax) <= max;
  }
  ...
  return (
    <Grow
      ...
      {...(checked ? { timeout: 800 } : {})}
    >
      <div className="fl-bg-white mt-3 border-raidus-10 p-3 position-absolute w-100 search-section" style={{width:"100%"}}>
        <div className="row">
                        ...
                        <div className="fl-small-card fl-border border-raidus-10">
                          <div className="mb-3 small-card-img-wrapper">
                            ...
                            <h3 className="text-white position-absolute position-absolute bottom-0 start-0 ms-2">
                              ...
                              <span className="fs-6 font-normal">Onwards</span>
                            </h3>
                          </div>
                          <div className="px-2 fl-small-card-detail">
                            ...
                            <p className="mb-1">
                              ...
                              <span style={{ fontSize: "14px" }}>
                                Project Area- {property.totalAcre}{" "}
                                {property?.plotArea
                                  ? property?.plotArea
                                  : "acre"}{" "}
                              </span>
                  ...
                  <li>
                    ...
                    >
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            hidden={filters.totalAcre !== "30-60"}
                            size="60px"
                            className="p-0"
                          />
                        }
                  ...
                  <li>
                    ...
                    >
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            hidden={filters.totalAcre !== "60-90"}
                            size="60px"
                            className="p-0"
                          />
                        }
                  ...
                  <li>
                    ...
                    >
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            hidden={filters.totalAcre !== "above"}
                            size="60px"
                            className="p-0"
                          />
                        }
                  ...
                  <li>
                    <p className="fs-6 mb-1">
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            hidden={!filters.aminities.includes("Electricity")}
                            size="60px"
                            className="p-0"
                          />
                        }
                  ...
                  <li>
                    <p className="fs-6 mb-1">
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            hidden={!filters.aminities.includes("Garden")}
                            size="60px"
                            className="p-0"
                          />
                        }
                  ...
                  <li>
                    <p className="fs-6 mb-1">
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            hidden={!filters.aminities.includes("Club House")}
                            size="60px"
                            className="p-0"
                          />
                        }
                  ...
                  <li>
                    <p className="fs-6 mb-1">
                      <FormControlLabel
                        ...
                        value={"50lac"}
                        name="price"
                        onChange={() => handlePriceChange(1, 5000000)}
                        checked={
                          Number(filters.priceMin) >= 1 &&
                          Number(filters.priceMax) <= 5000000
                        }
                  ...
                  <li>
                    <p className="fs-6 mb-1">
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            hidden={!showCheckbox(5000000, 7000000)}
                            size="60px"
                            className="p-0"
                          />
                        }
                        ...
                        value={"50lac-70lac"}
                        name="price"
                        onChange={() => handlePriceChange(5000000, 7000000)}
                        checked={
                          Number(filters.priceMin) >= 5000000 &&
                          Number(filters.priceMax) <= 7000000
                        }
                  ...
                  <li>
                    <p className="fs-6 mb-1">
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            hidden={!showCheckbox(7000000, 9000000)}
                            size="60px"
                            className="p-0"
                          />
                        }
                        ...
                        value={"70lac-90lac"}
                        name="price"
                        onChange={() => handlePriceChange(7000000, 9000000)}
                        checked={
                          Number(filters.priceMin) >= 7000000 &&
                          Number(filters.priceMax) <= 9000000
                        }
                    ...
                    <p className="fs-6 mb-1">
                      <FormControlLabel
                        className={`m-0 ${
                          ...
                          Number(filters.priceMax) <= 20000000 &&
                          "text-success"
                        }`}
                        control={
                          <Checkbox
                            hidden={!showCheckbox(10000000, 20000000)}
                            size="60px"
                            className="p-0"
                          />
                        }
                        ...
                        value={"1cr-2cr"}
                        name="price"
                        onChange={() => handlePriceChange(10000000, 20000000)}
                        checked={
                          Number(filters.priceMin) >= 10000000 &&
                          Number(filters.priceMax) <= 20000000
                        }
